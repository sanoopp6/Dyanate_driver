    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        image_view_map_change_icon.setOnClickListener {
            if (mMap != null) {
                ...
                if (ActivityCompat.checkSelfPermission(this@SenderLocationActivity, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this@SenderLocationActivity, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {

                    ActivityCompat.requestPermissions(this@SenderLocationActivity, arrayOf(Manifest.permission.ACCESS_FINE_LOCATION), MY_PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION)
                }
            ...
            UtilityFunctions.showAlertOnActivity(this@SenderLocationActivity,
                    ...
                    resources.getString(R.string.No).toString(), true, false,
                    {
                        if (!type_location_text_view.text.toString().equals(resources.getString(R.string.TypeYourLocation), true)) {
                            ...
                            startActivity(Intent(this@SenderLocationActivity, ReceiverLocationActivity::class.java))
                        }
                    }, {})
        }
